...
import { HsonTree } from "./hson-tree-class.tree.hson.js";
import { create_live_tree } from "./create-live-tree.tree.hson.js";
   ...
   * @returns {HsonTree}an HsonTree instance for querying and manipulating the grafted element
   */

  export function graft($element?: HTMLElement): HsonTree {
